  ...
  server.route({
    ...
    config: {
      auth: {
        mode: 'try',
        strategy: 'session',
        scope: PermissionConfigTable.GET['/login'] || DefaultScopes
      },
      plugins: {
        'hapi-auth-cookie': {
          redirectTo: false
  ...
  server.route({
    ...
    config: {
      auth: {
        mode: 'try',
        strategy: 'session',
        scope: PermissionConfigTable.GET['/logout'] || DefaultScopes
      },
      plugins: {
        'hapi-auth-cookie': {
          redirectTo: false
  ...
  server.route({
    ...
    config: {
      auth: {
        mode: 'try',
        strategy: 'session',
        scope: PermissionConfigTable.GET['/forgot'] || DefaultScopes
      },
      plugins: {
        'hapi-auth-cookie': {
          redirectTo: false
  ...
  server.route({
    ...
    config: {
      auth: {
        mode: 'try',
        strategy: 'session',
        scope: PermissionConfigTable.GET['/reset'] || DefaultScopes
      },
      plugins: {
        'hapi-auth-cookie': {
          redirectTo: false
