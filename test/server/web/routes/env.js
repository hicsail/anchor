...
const EnvPlugin = require('../../../../server/web/routes/env');
...
lab.before((done) => {
  ...
  const plugins = [Vision, VisionaryPlugin, HapiAuthBasic, HapiAuthCookie, HapiAuthJWT, ModelsPlugin, AuthPlugin, EnvPlugin];
