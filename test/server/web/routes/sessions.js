...
const SessionPlugin = require('../../../../server/web/routes/sessions');
...
lab.before((done) => {
  ...
  const plugins = [Vision, VisionaryPlugin, HapiAuthBasic, HapiAuthCookie, HapiAuthJWT, ModelsPlugin, AuthPlugin, SessionPlugin];
...
lab.experiment('SessionPlugin Page View', () => {
