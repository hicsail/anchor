...
const RolesPlugin = require('../../../../server/web/routes/roles');
...
lab.before((done) => {
    ...
    const plugins = [Vision, VisionaryPlugin, HapiAuthBasic, HapiAuthCookie, ModelsPlugin, AuthPlugin, RolesPlugin];
