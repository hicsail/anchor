...
const DashboardPlugin = require('../../../../server/web/routes/dashboard');
...
lab.before((done) => {
  ...
  const plugins = [Vision, VisionaryPlugin, HapiAuthBasic, HapiAuthCookie, HapiAuthJWT, ModelsPlugin, AuthPlugin, DashboardPlugin];
...
lab.experiment('Dashboard Page View', () => {
