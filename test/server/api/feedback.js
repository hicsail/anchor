...
lab.experiment('Feedback Plugin Result List', () => {
  ...
  lab.test('it returns an array of documents successfully using filters', (done) => {
    ...
    request.url = '/feedback?fields=username ip time&order[0][dir]=desc&search[value]=test';
  ...
  lab.test('it returns an array of documents successfully using filters', (done) => {
    ...
    request.url = '/feedback?fields=username ip time&order[0][dir]=asc&search[value]=test';
    request.credentials = AuthenticatedAnalyst;
